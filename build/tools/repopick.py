...
if __name__ == '__main__':
    # Default to Syberia Gerrit
    default_gerrit = 'http://gerrit.syberiaos.com'
    ...
    for project in projects:
        name = ("syberia-project/")+project.get('name')
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit syberia', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch syberia', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
